...
namespace MetricExporter
{
    public class RestCalls
    {
        ...
        public async Task<string> getMetrics(string metricData)
        {
            ...
            var path = metricData + "&output=json";  //"controller/rest/applications/BigLots-Prod/metric-data?metric-path=Business%20Transaction%20Performance%7CBusiness%20Transactions%7CSM-RemoteObjectServer%7CDevice%20-%20Work%20Lookup%7CAverage%20Response%20Time%20%28ms%29&time-range-type=BEFORE_NOW&duration-in-mins=43200&output=json";
